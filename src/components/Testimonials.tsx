...
const testimonials = [
    {
        ...
        name: "Emeka O.",
        role: "Lagos",
        content: "The quality is undeniable. The bag felt premium, the belt matched perfectly, and the whole order looked carefully selected.",
        tag: "STYLE"
    },
    {
        id: 2,
        name: "Sarah A.",
        role: "Abuja",
        content: "I ordered a complete gift set and the packaging was world-class. It felt personal, polished, and easy to recommend.",
        tag: "GIFTING"
    },
    {
        id: 3,
        name: "Tunde B.",
        role: "Port Harcourt",
        content: "Senator makes it easy to find pieces that work together. Clothes, frames, belts, and accessories all feel intentional.",
        tag: "CURATION"
    }
]
